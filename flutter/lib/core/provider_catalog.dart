...
const _kreaProvider = VideoProviderDefinition(
  id: 'krea',
  name: 'Krea',
  description:
      'Krea’s unified API across current video models from Google, ByteDance, Kling, MiniMax, Alibaba, and more.',
  consoleUrl: 'https://www.krea.ai/app/api',
  docsUrl: 'https://www.krea.ai/docs/',
  pricingUrl: 'https://www.krea.ai/docs/api-reference/introduction',
  pricingSource:
      'Fixed USD API prices published in Krea’s OpenAPI reference; the live spec is checked for additions',
  models: <VideoModelDefinition>[
    VideoModelDefinition(
      id: 'bytedance/seedance-2-5',
      canonicalModelId: 'seedance-2.5',
      label: 'Seedance 2.5',
      description: 'Long-form Seedance 2.5 with reference guidance and audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '4:3', '1:1', '3:4', '9:16', '21:9'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('sd', 'SD', '854 × 480'),
        VideoResolutionDefinition('hd', 'HD', '1280 × 720'),
        VideoResolutionDefinition('fhd', 'Full HD', '1920 × 1080'),
      ],
      minDuration: 4,
      maxDuration: 30,
      durationStep: 1,
    ...
    VideoModelDefinition(
      ...
      canonicalModelId: 'seedance-2.0',
      label: 'Seedance 2.0',
      description: 'Full-quality Seedance 2.0 multimodal generation up to 4K.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '4:3', '1:1', '3:4', '9:16', '21:9'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('sd', 'SD', '854 × 480'),
        VideoResolutionDefinition('hd', 'HD', '1280 × 720'),
        VideoResolutionDefinition('fhd', 'Full HD', '1920 × 1080'),
        VideoResolutionDefinition('4k', '4K', '3840 × 2160'),
      ],
      minDuration: 4,
      maxDuration: 15,
      durationStep: 1,
    ...
    VideoModelDefinition(
      ...
      canonicalModelId: 'seedance-2.0-fast',
      label: 'Seedance 2.0 Fast',
      description: 'Faster Seedance 2.0 at 480p or 720p.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '4:3', '1:1', '3:4', '9:16', '21:9'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('sd', 'SD', '854 × 480'),
    ...
    VideoModelDefinition(
      ...
      canonicalModelId: 'veo-3.1-fast',
      label: 'Veo 3.1 Fast',
      description: 'Faster Veo 3.1 generation with optional audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '9:16'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'HD', '1280 × 720'),
    ...
    VideoModelDefinition(
      ...
      label: 'Veo 3.1 Lite',
      description: 'Lowest-cost Veo 3.1 route without audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '9:16'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'HD', '1280 × 720'),
    ...
    VideoModelDefinition(
      id: 'kling/kling-3.0',
      canonicalModelId: 'kling-3.0',
      label: 'Kling 3.0',
      description: 'Kling 3.0 in standard, pro, or 4K quality with audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '9:16'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'Standard', '720p class · std'),
        VideoResolutionDefinition('fhd', 'Pro', '1080p class · pro'),
        VideoResolutionDefinition('4k', '4K', '2160p class · 4k'),
      ],
      minDuration: 3,
      maxDuration: 15,
      durationStep: 1,
    ...
    VideoModelDefinition(
      id: 'kling/kling-2.6',
      canonicalModelId: 'kling-2.6',
      label: 'Kling 2.6',
      description: 'Kling 2.6 with pinned frames and optional audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '9:16'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('fhd', 'Full HD', 'Default output'),
      ],
      minDuration: 5,
      maxDuration: 10,
      durationStep: 5,
      maxKeyframes: 2,
      usdPerSecond: 0.0735,
      referenceUsdPerSecond: 0.0735,
      supportsStartFrame: true,
      supportsEndFrame: true,
    ),
    VideoModelDefinition(
      id: 'kling/kling-o1',
      canonicalModelId: 'kling-o1',
      label: 'Kling o1',
      description: 'Kling o1 reasoning-guided generation with pinned frames.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
    ...
    VideoModelDefinition(
      ...
      canonicalModelId: 'hailuo-3',
      label: 'Hailuo 3',
      description: 'Reference-rich MiniMax generation with pinned frames.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>[
        'auto',
        '21:9',
      ...
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'HD', '768p class'),
      ],
      minDuration: 5,
      maxDuration: 15,
      durationStep: 1,
    ...
    VideoModelDefinition(
      ...
      description: 'MiniMax H3 Max generation at 480p or 768p.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
    ...
    VideoModelDefinition(
      ...
      label: 'Hailuo 2.3',
      description: 'Hailuo 2.3 with pinned frames at 768p or 1080p.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['auto'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'HD', '768p class'),
    ...
    VideoModelDefinition(
      ...
      canonicalModelId: 'hailuo-2.3-fast',
      label: 'Hailuo 2.3 Fast',
      description: 'Faster Hailuo 2.3 at 768p or 1080p.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['auto'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'HD', '768p class'),
      ...
      durationStep: 4,
      maxKeyframes: 2,
      usdPerSecond: 0.03325,
      referenceUsdPerSecond: 0.03325,
      supportsStartFrame: true,
      supportsEndFrame: true,
      supportsAudio: false,
    ),
    VideoModelDefinition(
      id: 'alibaba/wan-3.0',
      canonicalModelId: 'wan-3.0',
      label: 'Wan 3.0',
      description: 'Long-form Wan 3.0 with rich references and native audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['auto', '16:9', '4:3', '1:1', '3:4', '9:16'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('sd', 'SD', '854 × 480'),
        VideoResolutionDefinition('hd', 'HD', '1280 × 720'),
        VideoResolutionDefinition('fhd', 'Full HD', '1920 × 1080'),
    ...
    VideoModelDefinition(
      id: 'alibaba/wan-2.5',
      canonicalModelId: 'wan-2.5',
      label: 'Wan 2.5',
      description: 'Wan 2.5 generation with optional synchronized audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '9:16', '1:1'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('sd', 'SD', '854 × 480'),
    ...
    VideoModelDefinition(
      ...
      label: 'FLUX 3 Video',
      description:
          'BFL’s FLUX 3 Video with pinned frames, video input, and audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v, VideoMode.v2v],
      aspectRatios: <String>[
        '21:9',
        '2:1',
      ...
      maxKeyframes: 2,
      usdPerSecond: 0.17,
      referenceUsdPerSecond: 0.17,
      supportsStartFrame: true,
      supportsEndFrame: true,
      maxPromptCharacters: 5000,
    ),
    VideoModelDefinition(
      id: 'lightricks/ltx-video-2.5-pro',
      canonicalModelId: 'ltx-2.5-pro',
      label: 'LTX 2.5 Pro',
      description: 'Full-quality LTX 2.5 generation with native audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '9:16'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'HD', '1280 × 720'),
      ...
      maxKeyframes: 2,
      usdPerSecond: 0.126,
      referenceUsdPerSecond: 0.126,
      supportsStartFrame: true,
      supportsEndFrame: true,
    ),
    VideoModelDefinition(
      id: 'lightricks/ltx-video-2.5-fast',
      canonicalModelId: 'ltx-2.5-fast',
      label: 'LTX 2.5 Fast',
      description: 'Fast LTX 2.5 generation up to 4K with native audio.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '9:16'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'HD', '1280 × 720'),
        VideoResolutionDefinition('fhd', 'Full HD', '1920 × 1080'),
        VideoResolutionDefinition('qhd', 'QHD', '2560 × 1440'),
        VideoResolutionDefinition('4k', '4K', '3840 × 2160'),
      ],
      minDuration: 6,
      maxDuration: 20,
      ...
      maxKeyframes: 2,
      usdPerSecond: 0.0945,
      referenceUsdPerSecond: 0.0945,
      supportsStartFrame: true,
      supportsEndFrame: true,
    ),
    VideoModelDefinition(
      id: 'luma/ray-2',
      canonicalModelId: 'luma-ray-2',
      label: 'Ray 2',
      description: 'Luma Ray 2 five-second generation up to Full HD.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>[
        '1:1',
        '16:9',
      ...
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('sd', 'SD', '960 × 540 base'),
        VideoResolutionDefinition('hd', 'HD', '1280 × 720 base'),
        VideoResolutionDefinition('fhd', 'Full HD', '1920 × 1080 base'),
      ],
      minDuration: 5,
      maxDuration: 5,
      durationStep: 1,
    ...
    VideoModelDefinition(
      ...
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('hd', 'HD', '1280 × 720 class'),
      ],
      minDuration: 2,
      maxDuration: 10,
      durationStep: 1,
    ...
    VideoModelDefinition(
      ...
      label: 'Vidu Q3',
      description: 'Vidu Q3 generation with audio from one to sixteen seconds.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
      aspectRatios: <String>['16:9', '9:16'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('sd', 'SD', '960 × 540'),
        VideoResolutionDefinition('hd', 'HD', '1280 × 720'),
        VideoResolutionDefinition('fhd', 'Full HD', '1920 × 1080'),
      ],
      minDuration: 1,
    ...
    VideoModelDefinition(
      id: 'xai/grok-video-1.5',
      canonicalModelId: 'grok-imagine-video-1.5',
      label: 'Grok Imagine 1.5',
      description:
          'Fast Grok generation with image or video input up to Full HD.',
      modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v, VideoMode.v2v],
      aspectRatios: <String>['16:9', '9:16', '1:1'],
      resolutions: <VideoResolutionDefinition>[
        VideoResolutionDefinition('sd', 'SD', '854 × 480'),
...
VideoProviderDefinition get kreaProvider =>
    providerByIdOrNull('krea') ?? _kreaProvider;
...
List<ProviderModelPrice> publishedProviderPrices(String providerId) {
  ...
  if (providerId == 'krea') {
    return _availablePublishedPrices(providerId, const <ProviderModelPrice>[
      ProviderModelPrice(
        provider: 'krea',
        model: 'alibaba/wan-2.5:480p',
        canonicalModelId: 'wan-2.5',
        label: 'Wan 2.5 · SD',
        usdPerSecond: 0.0525,
        referenceUsdPerSecond: 0.0525,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 5,
        maxDuration: 10,
        durationStep: 5,
      ),
      ProviderModelPrice(
        provider: 'krea',
        model: 'alibaba/wan-2.5:720p',
        canonicalModelId: 'wan-2.5',
        label: 'Wan 2.5 · HD',
        usdPerSecond: 0.105,
        referenceUsdPerSecond: 0.105,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 5,
        maxDuration: 10,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'alibaba/wan-2.5:1080p',
        canonicalModelId: 'wan-2.5',
        label: 'Wan 2.5 · Full HD',
        usdPerSecond: 0.1575,
        referenceUsdPerSecond: 0.1575,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 5,
        maxDuration: 10,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'alibaba/wan-3.0:1080p',
        canonicalModelId: 'wan-3.0',
        label: 'Wan 3.0 · Full HD',
        usdPerSecond: 0.3,
        referenceUsdPerSecond: 0.3,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 2,
        maxDuration: 30,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'black-forest-labs/flux-3-video:720p',
        canonicalModelId: 'flux-3',
        label: 'FLUX 3 Video · HD',
        usdPerSecond: 0.17,
        referenceUsdPerSecond: 0.17,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v, VideoMode.v2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'black-forest-labs/flux-3-video:1080p',
        canonicalModelId: 'flux-3',
        label: 'FLUX 3 Video · Full HD',
        usdPerSecond: 0.29,
        referenceUsdPerSecond: 0.29,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v, VideoMode.v2v],
        source: 'published · fixed USD API price',
        minDuration: 5,
        maxDuration: 20,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2:480p',
        canonicalModelId: 'seedance-2.0',
        label: 'Seedance 2.0 · SD',
        usdPerSecond: 0.1415,
        referenceUsdPerSecond: 0.1415,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2:720p',
        canonicalModelId: 'seedance-2.0',
        label: 'Seedance 2.0 · HD',
        usdPerSecond: 0.3186,
        referenceUsdPerSecond: 0.3186,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2:1080p',
        canonicalModelId: 'seedance-2.0',
        label: 'Seedance 2.0 · Full HD',
        usdPerSecond: 0.7168,
        referenceUsdPerSecond: 0.7168,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2:4K',
        canonicalModelId: 'seedance-2.0',
        label: 'Seedance 2.0 · 4K',
        usdPerSecond: 2.8671,
        referenceUsdPerSecond: 2.8671,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2-5:480p',
        canonicalModelId: 'seedance-2.5',
        label: 'Seedance 2.5 · SD',
        usdPerSecond: 0.1078,
        referenceUsdPerSecond: 0.1078,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2-5:720p',
        canonicalModelId: 'seedance-2.5',
        label: 'Seedance 2.5 · HD',
        usdPerSecond: 0.2427,
        referenceUsdPerSecond: 0.2427,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 30,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2-5:1080p',
        canonicalModelId: 'seedance-2.5',
        label: 'Seedance 2.5 · Full HD',
        usdPerSecond: 0.4299,
        referenceUsdPerSecond: 0.4299,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 30,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2-fast:480p',
        canonicalModelId: 'seedance-2.0-fast',
        label: 'Seedance 2.0 Fast · SD',
        usdPerSecond: 0.1129,
        referenceUsdPerSecond: 0.1129,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2-fast:720p',
        canonicalModelId: 'seedance-2.0-fast',
        label: 'Seedance 2.0 Fast · HD',
        usdPerSecond: 0.254,
        referenceUsdPerSecond: 0.254,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2-mini:480p',
        canonicalModelId: 'seedance-2.0-mini',
        label: 'Seedance 2.0 Mini · SD',
        usdPerSecond: 0.0706,
        referenceUsdPerSecond: 0.0706,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'bytedance/seedance-2-mini:720p',
        canonicalModelId: 'seedance-2.0-mini',
        label: 'Seedance 2.0 Mini · HD',
        usdPerSecond: 0.1587,
        referenceUsdPerSecond: 0.1587,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1:720p:audio',
        canonicalModelId: 'veo-3.1',
        label: 'Veo 3.1 · HD · Audio',
        usdPerSecond: 0.42,
        referenceUsdPerSecond: 0.42,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 8,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1:1080p',
        canonicalModelId: 'veo-3.1',
        label: 'Veo 3.1 · Full HD',
        usdPerSecond: 0.21,
        referenceUsdPerSecond: 0.21,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1:4K:audio',
        canonicalModelId: 'veo-3.1',
        label: 'Veo 3.1 · 4K · Audio',
        usdPerSecond: 0.63,
        referenceUsdPerSecond: 0.63,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 8,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1-fast:720p',
        canonicalModelId: 'veo-3.1-fast',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1-fast:720p:audio',
        canonicalModelId: 'veo-3.1-fast',
        label: 'Veo 3.1 Fast · HD · Audio',
        usdPerSecond: 0.105,
        referenceUsdPerSecond: 0.105,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1-fast:1080p',
        canonicalModelId: 'veo-3.1-fast',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1-fast:1080p:audio',
        canonicalModelId: 'veo-3.1-fast',
        label: 'Veo 3.1 Fast · Full HD · Audio',
        usdPerSecond: 0.126,
        referenceUsdPerSecond: 0.126,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1-fast:4K',
        canonicalModelId: 'veo-3.1-fast',
        label: 'Veo 3.1 Fast · 4K',
        usdPerSecond: 0.2625,
        referenceUsdPerSecond: 0.2625,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 8,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1-fast:4K:audio',
        canonicalModelId: 'veo-3.1-fast',
        label: 'Veo 3.1 Fast · 4K · Audio',
        usdPerSecond: 0.315,
        referenceUsdPerSecond: 0.315,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 4,
        maxDuration: 8,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1-lite:720p',
        canonicalModelId: 'veo-3.1-lite',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'google/veo-3.1-lite:1080p',
        canonicalModelId: 'veo-3.1-lite',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'kling/kling-2.6:1080p:audio',
        canonicalModelId: 'kling-2.6',
        label: 'Kling 2.6 · Audio',
        usdPerSecond: 0.147,
        referenceUsdPerSecond: 0.147,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 5,
        maxDuration: 10,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'kling/kling-3.0:720p:audio',
        canonicalModelId: 'kling-3.0',
        label: 'Kling 3.0 · Standard · Audio',
        usdPerSecond: 0.2646,
        referenceUsdPerSecond: 0.2646,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 3,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'kling/kling-3.0:1080p',
        canonicalModelId: 'kling-3.0',
        label: 'Kling 3.0 · Pro',
        usdPerSecond: 0.2352,
        referenceUsdPerSecond: 0.2352,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 3,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'kling/kling-3.0:1080p:audio',
        canonicalModelId: 'kling-3.0',
        label: 'Kling 3.0 · Pro · Audio',
        usdPerSecond: 0.3528,
        referenceUsdPerSecond: 0.3528,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 3,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'kling/kling-3.0:4K',
        canonicalModelId: 'kling-3.0',
        label: 'Kling 3.0 · 4K',
        usdPerSecond: 0.441,
        referenceUsdPerSecond: 0.441,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 3,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'kling/kling-3.0:4K:audio',
        canonicalModelId: 'kling-3.0',
        label: 'Kling 3.0 · 4K · Audio',
        usdPerSecond: 0.441,
        referenceUsdPerSecond: 0.441,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'lightricks/ltx-video-2.5-fast:720p',
        canonicalModelId: 'ltx-2.5-fast',
        label: 'LTX 2.5 Fast · HD',
        usdPerSecond: 0.0945,
        referenceUsdPerSecond: 0.0945,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'lightricks/ltx-video-2.5-fast:1080p',
        canonicalModelId: 'ltx-2.5-fast',
        label: 'LTX 2.5 Fast · Full HD',
        usdPerSecond: 0.1365,
        referenceUsdPerSecond: 0.1365,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'lightricks/ltx-video-2.5-fast:1440p',
        canonicalModelId: 'ltx-2.5-fast',
        label: 'LTX 2.5 Fast · QHD',
        usdPerSecond: 0.1995,
        referenceUsdPerSecond: 0.1995,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 6,
        maxDuration: 20,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'lightricks/ltx-video-2.5-fast:4K',
        canonicalModelId: 'ltx-2.5-fast',
        label: 'LTX 2.5 Fast · 4K',
        usdPerSecond: 0.315,
        referenceUsdPerSecond: 0.315,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'lightricks/ltx-video-2.5-pro:720p',
        canonicalModelId: 'ltx-2.5-pro',
        label: 'LTX 2.5 Pro · HD',
        usdPerSecond: 0.126,
        referenceUsdPerSecond: 0.126,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'lightricks/ltx-video-2.5-pro:1080p',
        canonicalModelId: 'ltx-2.5-pro',
        label: 'LTX 2.5 Pro · Full HD',
        usdPerSecond: 0.1785,
        referenceUsdPerSecond: 0.1785,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 6,
        maxDuration: 10,
      ...
      ProviderModelPrice(
        ...
        minDuration: 5,
        maxDuration: 5,
        durationPrices: <int, double>{5: 0.42},
      ),
      ProviderModelPrice(
        provider: 'krea',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'minimax/h3-max:480p',
        canonicalModelId: 'minimax-h3-max',
        label: 'MiniMax H3 Max · SD',
        usdPerSecond: 0.025,
        referenceUsdPerSecond: 0.025,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'minimax/h3-max:720p',
        canonicalModelId: 'minimax-h3-max',
        label: 'MiniMax H3 Max · HD',
        usdPerSecond: 0.04,
        referenceUsdPerSecond: 0.04,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 5,
        maxDuration: 15,
      ...
      ProviderModelPrice(
        ...
        maxDuration: 10,
        durationStep: 4,
        durationPrices: <int, double>{6: 0.294, 10: 0.588},
      ),
      ProviderModelPrice(
        provider: 'krea',
        model: 'minimax/hailuo-2.3:1080p',
        canonicalModelId: 'hailuo-2.3',
        label: 'Hailuo 2.3 · Full HD',
        usdPerSecond: 0.08575,
        referenceUsdPerSecond: 0.08575,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 6,
        maxDuration: 10,
        durationStep: 4,
        durationPrices: <int, double>{6: 0.5145, 10: 0.5145},
      ),
      ProviderModelPrice(
        provider: 'krea',
        model: 'minimax/hailuo-2.3-fast:720p',
        canonicalModelId: 'hailuo-2.3-fast',
        label: 'Hailuo 2.3 Fast · HD',
        usdPerSecond: 0.03325,
        referenceUsdPerSecond: 0.03325,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'minimax/hailuo-2.3-fast:1080p',
        canonicalModelId: 'hailuo-2.3-fast',
        label: 'Hailuo 2.3 Fast · Full HD',
        usdPerSecond: 0.05775,
        referenceUsdPerSecond: 0.05775,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v],
        source: 'published · fixed USD API price',
        minDuration: 6,
        maxDuration: 10,
        durationStep: 4,
        durationPrices: <int, double>{6: 0.3465, 10: 0.3465},
      ),
      ProviderModelPrice(
        provider: 'krea',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'xai/grok-video-1.5:480p',
        canonicalModelId: 'grok-imagine-video-1.5',
        label: 'Grok Imagine 1.5 · SD',
        usdPerSecond: 0.084,
        referenceUsdPerSecond: 0.084,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v, VideoMode.v2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'xai/grok-video-1.5:720p',
        canonicalModelId: 'grok-imagine-video-1.5',
        label: 'Grok Imagine 1.5 · HD',
        usdPerSecond: 0.147,
        referenceUsdPerSecond: 0.147,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v, VideoMode.v2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'xai/grok-video-1.5:1080p',
        canonicalModelId: 'grok-imagine-video-1.5',
        label: 'Grok Imagine 1.5 · Full HD',
        usdPerSecond: 0.2625,
        referenceUsdPerSecond: 0.2625,
        modes: <VideoMode>[VideoMode.t2v, VideoMode.i2v, VideoMode.v2v],
        source: 'published · fixed USD API price',
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'black-forest-labs/flux-3-video:720p:edit',
        canonicalModelId: 'flux-3',
        label: 'FLUX 3 Video · HD · Edit',
        usdPerSecond: 0.41,
        referenceUsdPerSecond: 0.41,
        modes: <VideoMode>[VideoMode.v2v],
        source: 'published · fixed USD API price',
        minDuration: 5,
        maxDuration: 20,
      ...
      ProviderModelPrice(
        provider: 'krea',
        model: 'black-forest-labs/flux-3-video:1080p:edit',
        canonicalModelId: 'flux-3',
        label: 'FLUX 3 Video · Full HD · Edit',
        usdPerSecond: 0.53,
        referenceUsdPerSecond: 0.53,
        modes: <VideoMode>[VideoMode.v2v],
        source: 'published · fixed USD API price',
        minDuration: 5,
        maxDuration: 20,
