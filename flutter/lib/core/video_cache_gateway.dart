...
/// Surfaces that keep a bounded local cache of delivered video files.
///
...
abstract interface class VideoCacheGateway {
  /// Total bytes currently held by the local video cache, or 0 when the
  /// surface cannot measure it.
  Future<int> videoCacheUsedBytes();

  /// Deletes every cached video file.
